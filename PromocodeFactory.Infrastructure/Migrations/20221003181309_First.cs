    ...
    public partial class First : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    CustomersCustomerId = table.Column<Guid>(type: "uuid", nullable: false),
                    PromoCodesPromoCodeId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerPromoCode", x => new { x.CustomersCustomerId, x.PromoCodesPromoCodeId });
                    table.ForeignKey(
                        name: "FK_CustomerPromoCode_Customer_CustomersCustomerId",
                        column: x => x.CustomersCustomerId,
                        principalTable: "Customer",
                        principalColumn: "CustomerId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomerPromoCode_PromoCode_PromoCodesPromoCodeId",
                        column: x => x.PromoCodesPromoCodeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerPromoCode_PromoCodesPromoCodeId",
                table: "CustomerPromoCode",
                column: "PromoCodesPromoCodeId");
